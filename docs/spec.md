...
- [ ] Реализовать первый вариант скрипта сборки шрифта `build.py`
- [ ] Реализовать первый вариант `specimen.html`
- [ ] Проверить читаемость тестового прямоугольника на 10px в браузере
