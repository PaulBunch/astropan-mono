...
| Baseline                      | 0                           |                              |
| Advance width                 | [смотри раздел 3.2](#32-адаптивная-моноширинность) |       |
...
5. **Критерий выбора модуля:** Если внутренние зазоры глифа в базовом модуле становятся меньше 100 UPM, выбирается расширенный модуль. Приоритет отдается сохранению толщины основного штриха 80 UPM над компактностью по ширине.
...
1. **Читаемость:** 100% распознаваемость всех глифов при кегле 10px в Chrome и Firefox. На дисплеях с низкой плотностью (96 DPI) допускается антиалиасинг, не искажающий общую форму (скелет) знака.
2. **Геометрия:** Отклонение толщины штриха от 80 UPM не более -5/+10 UPM
